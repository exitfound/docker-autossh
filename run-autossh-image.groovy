pipeline {
    ...
    parameters {
        ...
        string(name: 'SSH_TUNNEL_LOCALEPORT', defaultValue: '', trim: true, description: 'Локальный порт, представляющий собой сервис, который будет проброшен с конечного инстанса:')
    }
